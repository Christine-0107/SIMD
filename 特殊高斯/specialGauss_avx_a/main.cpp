...
public:
    ...
    bool xorBitList(BitList b)
    {
        ...
        for(;j<byteNum-8;j+=8)
        {
            t1=_mm256_load_si256((__m256i*)(this->byteArray+j));
            t2=_mm256_load_si256((__m256i*)(b.byteArray+j));
            t3=_mm256_xor_si256(t1,t2);
            _mm256_store_si256((__m256i*)(this->byteArray+j),t3);
    ...
    void setBitList(BitList b)
    {
        ...
        for(;j<byteNum-8;j+=8)
        {
            t4=_mm256_load_si256((__m256i*)(b.byteArray+j));
            _mm256_store_si256((__m256i*)(this->byteArray+j),t4);
...
{
    int data;
    //elit=reinterpret_cast<BitList*>(_aligned_malloc(sizeof(BitList)*maxColNum, 32));
    //elitLine=reinterpret_cast<BitList*>(_aligned_malloc(sizeof(BitList)*elitLineNum, 32));
