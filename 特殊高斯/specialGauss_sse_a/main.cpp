...
public:
    ...
    bool xorBitList(BitList b)
    {
        ...
        for(;j<byteNum-4;j+=4)
        {
            t1=_mm_load_si128((__m128i*)(this->byteArray+j));
            t2=_mm_load_si128((__m128i*)(b.byteArray+j));
            t3=_mm_xor_si128(t1,t2);
            _mm_store_si128((__m128i*)(this->byteArray+j),t3);
    ...
    void setBitList(BitList b)
    {
        ...
        for(;j<byteNum-4;j+=4)
        {
            t4=_mm_load_si128((__m128i*)(b.byteArray+j));
            _mm_store_si128((__m128i*)(this->byteArray+j),t4);
